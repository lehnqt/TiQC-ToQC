...
tno2=reshape(tno,[4,4]);
tno2=tno2';
tno2=reshape(tno2,[2,2,2,2]);
dm2=size(tno,2);
dm4=size(tno,1);
dm1=size(A0,1);
dm3=size(A0,3);
...
A=reshape(Utemp*sqrt(S),[dm1,dm2,dm3,dtemp]);
B=reshape(sqrt(S)*Vhtemp,[dtemp,dm4,dm5,dm6]);
end